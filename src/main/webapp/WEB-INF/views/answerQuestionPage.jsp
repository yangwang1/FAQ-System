...
<!--          <input type="hidden" name="_method" value="PUT"/>  -->
    ...
    <tr>
       <td>问题:</td>
       <td><form:input path="title.title" id="title" disabled="true" class="form-control" style="height: 60px; width: 400px;"/></td>
    </tr>
    <tr>
       <td>答案:</td>
       <td><form:textarea path="content.content" class="form-control" style="height: 150px; width: 400px;"/></td>
    </tr>
    <tr>
